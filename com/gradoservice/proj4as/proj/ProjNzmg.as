		...
		public function ProjNzmg(data:ProjParams)
		{
		  ...
		  */
		  override public function forward(p:ProjPoint):ProjPoint
		  {
		    ...
		    var d_phi:Number = delta_lat / ProjConstants.SEC_TO_RAD * 1E-5;       var d_lambda:Number = delta_lon;
		    ...
		    // 2. Calculate theta
		    var th_re:Number = d_psi;                                              var th_im:Number = d_lambda;
		
		    // 3. Calculate z
		    var th_n_re:Number = 1;                                                var th_n_im:Number = 0;  // theta^0
		    var th_n_re1:Number;                                                   var th_n_im1:Number;
		
		    var z_re:Number = 0;                                                   var z_im:Number = 0;
		    for (n = 1; n <= 6; n++) {
		 ...
		 override public function inverse(p:ProjPoint):ProjPoint
		 {
		    ...
		    // 1. Calculate z
		    var z_re:Number = delta_y / this.a;                                              var z_im:Number = delta_x / this.a;
		
		    // 2a. Calculate theta - first approximation gives km accuracy
		    var z_n_re:Number = 1;                                                           var z_n_im:Number = 0;  // z^0
		    var z_n_re1:Number;                                                              var z_n_im1:Number;
		
		    var th_re:Number = 0;                                                            var th_im:Number = 0;
		    ...
		    for (var i:int = 0; i < this.iterations; i++) {
		       var th_n_re:Number = th_re;                                                      var th_n_im:Number = th_im;
		       var th_n_re1:Number;                                                             var th_n_im1:Number;
		
		       var num_re:Number = z_re;                                                        var num_im:Number = z_im;
		       for (n = 2; n <= 6; n++) {
		         th_n_re1 = th_n_re*th_re - th_n_im*th_im;                               th_n_im1 = th_n_im*th_re + th_n_re*th_im;
		         th_n_re = th_n_re1;                                                     th_n_im = th_n_im1;
		       ...
		       th_n_re = 1;                                                              th_n_im = 0;
		       var den_re:Number = this.B_re[1];                                                var den_im:Number = this.B_im[1];
		       for (n = 2; n <= 6; n++) {
		         th_n_re1 = th_n_re*th_re - th_n_im*th_im;                               th_n_im1 = th_n_im*th_re + th_n_re*th_im;
		         th_n_re = th_n_re1;                                                     th_n_im = th_n_im1;
		    ...
		    var d_psi:Number = th_re;                                                        var d_lambda:Number = th_im;
